            ...
            <div>
              ...
              >
                ...
                <div>
                  ...
                  {/* Selector interactivo con logos oficiales exclusivamente */}
                  <div style={{ display: 'flex', gap: '0.6rem', marginBottom: '0.6rem' }}>
                    {[
                      ...
                      },
                      {
                        ...
                        svg: (
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 1 1-5.2-1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V5.8a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 3 12a6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.76a4.85 4.85 0 0 1-1.16-.07z" />
                          </svg>
                        ),
                      },
                      {
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            background: active ? 'rgba(0, 229, 255, 0.22)' : 'rgba(12, 12, 12, 0.8)',
